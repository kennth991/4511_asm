    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (requestURI.endsWith("/logout")) {
                System.out.println("Logging out, redirecting to login page");
            ...
            if (user == null) {
                ...
                System.out.println(
                        "User is " + user.getUsername() + " with role " + user.getRole() + ", checking access");
                switch (user.getRole()) {
                    case "user":
                        if (requestURI.contains("/admin") || requestURI.contains("/staff")
                                || requestURI.contains("/technician")
                                || requestURI.contains("/courier")) {
                            res.sendRedirect(req.getContextPath() + "/user/");
                        }
                        break;
                    case "staff":
                        if (requestURI.contains("/admin") || requestURI.contains("/technician")
                                || requestURI.contains("/courier")) {
                    ...
                    case "technician":
                        if (requestURI.contains("/user") || requestURI.contains("/admin")
                                ...
                                || requestURI.contains("/courier")) {
                            res.sendRedirect(req.getContextPath() + "/technician/");
                        }
                        break;
                    case "courier":
                        if (requestURI.contains("/user") || requestURI.contains("/admin")
                                || requestURI.contains("/staff")
                                || requestURI.contains("/technician")) {
                            res.sendRedirect(req.getContextPath() + "/courier/");
                        }
                        break;
                    case "administrator":
                        break;
